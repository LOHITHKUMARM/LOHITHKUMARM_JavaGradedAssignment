...
class ProjectSerializer {
      ...
      private void serializeProjectDetails(HashMap<Project, ArrayList<Employee>> projectmap12) {
         try {
      			final FileOutputStream foutstream = new FileOutputStream("Serializer1.txt", true);
      			...
      			System.out.println("Map Serialiazed Successfully!");
      		}catch (IOException e) {
      			e.printStackTrace();
      		}		
      	}
